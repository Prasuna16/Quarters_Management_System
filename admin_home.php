...
<body>
<div class="p-3 mb-2 text-white welcome" style="text-align: center; font-size: 23px;">Hello <?php echo $name ?>, Welcome!</div>
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 2.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="enroll_manager.php">Register a Manager</a></h5>
    <p class="card-text">Click the above link to enroll a new Manager.</p>
  </div>
</div>
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="managers_list.php">Managers</a></h5>
    <p class="card-text">Click the above link to see the list of managers working.</p>
  </div>
</div>
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="availability_rooms.php">Check Availabilty</a></h5>
...
<div class="card mb-3" style="width: 80%; margin-left: 10%; margin-top: 1.5%;">
  <img src="bluebg.png" class="card-img-top" height="10" alt="">
  <div class="card-body">
    <h5 class="card-title"><a href="electricity_bills.php">Electricity bills</a></h5>
