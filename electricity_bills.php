<?php 
  ...
  <?php }else { 
      ...
      $query = "SELECT RoomNo, Name, MobileNo, Bills, BookedDate FROM users where BillStatus = 'Pending'";
      $res = mysqli_query($conn, $query);
      $pending = mysqli_fetch_all($res, MYSQLI_ASSOC);
      $query = "SELECT RoomNo, Name, MobileNo, Bills, BookedDate FROM users where BillStatus = 'Paid'";
      $res = mysqli_query($conn, $query);
