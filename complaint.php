<?php 
  ...
  <?php }else { 
      ...
      $query = "SELECT u.ID,u.Name,u.RoomNo,c.details,c.Status FROM complaints c join users u on c.id_person=u.ID where u.RoomNo!='-1' and u.ID!='-1'";
      ...
      for($j=0;$j<count($list);$j++){
        ...
        if(!empty($_POST["$r"])){
          if($flag[$j]==1){
            $query1="UPDATE complaints SET Status='Resolved' where id_person='$r'";
            $flag[$j]=0;
          }
...
<body>
  <div class="container-fluid">
    ...
    <div class="welcome">--COMPLAINTS INFORMATION--</div></div><br>
  ...
  <thead>
    <tr class="table-primary">
      ...
      <th style="text-align: center;" scope="col">Complaint</th>
      <th style="text-align: center;" scope="col">Status of the complaint</th>
